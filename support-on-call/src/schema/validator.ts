/**
 * Schema.org Type Validator for Product, ProductGroup, Offer, and Organization/Business nodes.
 */
...
export class SchemaValidator {
  /**
   * Returns true if the node is a Schema.org Product or ProductGroup.
   */
  ...
  /**
   * Returns true if the node represents an Organization or LocalBusiness.
   */
  ...
  /**
   * Extracts clean Product price and availability from a Schema.org Offer node.
   */
